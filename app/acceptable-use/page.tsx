...
export const metadata: Metadata = {
  title: "CartonFlow Acceptable Use Policy — Pevara Systems",
  description: "What you can and cannot use CartonFlow for.",
};
...
<div class="page-wrap">
  ...
  <h1 class="page-title">Acceptable<br/><span class='g'>Use Policy.</span></h1>
  <p class="page-date">Last updated: March 22, 2026 &nbsp;·&nbsp; Effective: March 22, 2026</p>
  
<div class="highlight"><p><strong>Short version:</strong> Use CartonFlow for legitimate logistics management. Don't do anything illegal, harmful, or abusive.</p></div>

<h2>1. Permitted Use</h2>
<p>CartonFlow is designed for logistics visibility and management by e-commerce brands, Amazon sellers, and their supply chain partners. You may use CartonFlow for any lawful business logistics purpose.</p>

<h2>2. Prohibited Activities</h2>
<p>You may not use CartonFlow to:</p>
<ul>
  <li>Violate any applicable law or regulation</li>
  <li>Ship, track, or facilitate the movement of illegal goods</li>
  <li>Impersonate any person or organization</li>
  <li>Attempt to gain unauthorized access to other accounts or systems</li>
  <li>Scrape, crawl, or extract data from the platform in bulk</li>
  <li>Reverse-engineer, decompile, or attempt to extract source code</li>
  <li>Transmit malware, viruses, or malicious code</li>
  <li>Harass, abuse, or threaten other users on the platform</li>
...
<p>You are responsible for the accuracy of data you enter into CartonFlow. Do not enter false, misleading, or fraudulent logistics information.</p>

<h2>4. Enforcement</h2>
<p>We reserve the right to suspend or terminate accounts that violate this policy, with or without notice depending on severity. Serious violations (illegal activity, security attacks) result in immediate termination without refund.</p>

<h2>5. Reporting Violations</h2>
<p>To report a violation: <a href="mailto:info@pevarasystems.com">info@pevarasystems.com</a></p>
