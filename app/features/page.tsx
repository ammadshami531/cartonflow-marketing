...
<section id="freight" class="category">
  <div class="container">
    ...
    <div class="feature-cards">
      ...
      <div class="feature-card"><div class="feature-card-icon"><svg class="icon-lg"><use href="#i-truck"/></svg></div><div class="feature-card-title">Last-mile carton scans</div><div class="feature-card-desc">100+ carriers via Shippo &mdash; FedEx, UPS, USPS, DHL, regional last-mile. Scan events per carton, geocoded onto the same map. Know which box landed at which FC, not just which shipment.</div></div>
    ...
    <div class="deep-row">
      <div class="deep-text">
        ...
        <p>The Live Map shows your entire freight footprint at once. AIS-tracked vessels with port ETAs, last-mile carton scans from 100+ carriers (via Shippo) geocoded onto the same view, warehouse drop-offs marked. Filter by status (transit, customs, last mile, delayed) and click any pin for the shipment detail without leaving the map.</p>
        <ul class="deep-list">
...
<section id="integrations" class="category">
  <div class="container">
    ...
    <div class="feature-cards">
      ...
      <div class="feature-card"><div class="feature-card-icon"><svg class="icon-lg"><use href="#i-truck"/></svg></div><div class="feature-card-title">Shippo &mdash; 100+ carriers</div><div class="feature-card-desc">Carton-level scan events from FedEx, UPS, USPS, DHL Express, regional last-mile carriers, and 90+ more &mdash; all via Shippo&rsquo;s carrier network. One integration, every shipment.</div></div>
