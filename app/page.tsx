...
<div class="faq-section">
  <div class="faq-inner">
    ...
    <div class="faq-item"><button class="faq-q" onclick="tf(this)"><span>What happens after the 14-day trial?</span><span class="faq-icon">▾</span></button><div class="faq-body">At the end of your trial, your card on file is charged $129/mo for the Pro plan. You can cancel any time before the trial ends from your account settings and you won't be charged.</div></div>
