...
.fp-content{position:relative;z-index:2;max-width:480px;padding:80px 60px}
...
.fp-tag{display:inline-flex;align-items:center;gap:6px;font-size:10px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#a5b4fc;margin-bottom:18px}
...
.fp-content p{font-size:15px;color:rgba(238,242,255,0.5);line-height:1.8;margin-bottom:24px}
.fp-list{list-style:none;display:flex;flex-direction:column;gap:8px;margin-bottom:28px}
.fp-list li{display:flex;gap:10px;font-size:13px;color:rgba(238,242,255,0.65);align-items:center}
...
.stat-l{font-size:13px;color:rgba(238,242,255,0.35);line-height:1.5}
...
.pain-label{font-size:14px;font-weight:700;color:#eef2ff;margin-bottom:10px}
.pain-desc{font-size:13px;color:rgba(238,242,255,0.45);line-height:1.65}
  ...
  <div class="plans">
    ...
    <div class="plan pro">
      ...
      <div class="plan-section">
        <div class="plan-section-title">AI Command Center</div>
        <ul class="feat-list">
          <li class="inc"><span class="chk">✓</span> <strong>AI Daily Brief</strong> — morning shipment summary</li>
          <li class="inc"><span class="chk">✓</span> <strong>AI Draft Messages</strong> — auto-written 3PL comms</li>
          <li class="inc"><span class="chk">✓</span> <strong>Predictive ETA</strong> — AI-adjusted arrival estimates</li>
          <li class="inc"><span class="chk">✓</span> <strong>Smart Delay Alerts</strong> — proactive, not reactive</li>
          <li class="inc"><span class="chk">✓</span> <strong>FBA Window Warning</strong> — never miss a receive window</li>
          <li class="inc"><span class="chk">✓</span> <strong>3PL Intelligence</strong> — AI partner performance insights</li>
          <li class="inc"><span class="chk">✓</span> <strong>Freight Cost Intelligence</strong> — live rate benchmarking</li>
          <li class="inc"><span class="chk">✓</span> <strong>ROI Dashboard</strong> — see exactly what CartonFlow saves you</li>
        </ul>
      </div>
    </div>
  </div>
