...
export const metadata: Metadata = {
  title: "CartonFlow Support — Contact Pevara Systems",
  description: "Get help with CartonFlow. Email info@pevarasystems.com — real humans, fast responses.",
};
...
<div class="page-wrap">
  ...
  <h1 class="page-title">Contact &amp;<br/><span class='g'>Support.</span></h1>
  <p class="page-date">Last updated: March 22, 2026 &nbsp;·&nbsp; Effective: March 22, 2026</p>
  
<div class="highlight"><p>We're a small team and we actually read our email. Expect a real response within 1 business day — usually faster.</p></div>

<h2>Get in Touch</h2>
<h3>General support &amp; billing</h3>
<p><a href="mailto:info@pevarasystems.com">info@pevarasystems.com</a></p>
<p>For account issues, billing questions, feature requests, and anything else CartonFlow-related.</p>

<h3>Bug reports</h3>
<p>Found something broken? Email <a href="mailto:info@pevarasystems.com">info@pevarasystems.com</a> with a description of what happened, what you expected, and your browser/OS. Screenshots help.</p>

<h3>Partner (3PL) onboarding</h3>
<p>If your customer has invited you to CartonFlow and you need help getting started, email us and we'll walk you through it. The partner portal is free and always will be.</p>

<h2>Response Times</h2>
<ul>
  <li><strong>Billing issues:</strong> Within 1 business day</li>
  <li><strong>Technical bugs:</strong> Within 1–2 business days</li>
  <li><strong>Feature requests:</strong> We read every one, even if we can't respond to all</li>
  <li><strong>Urgent / platform down:</strong> Subject line "URGENT" — we prioritize these</li>
</ul>

<h2>Useful Links</h2>
<ul>
  <li><a href="/">CartonFlow Homepage</a></li>
  <li><a href="/features">Features Deep-Dive</a></li>
  <li><a href="https://app.cartonflow.io/login">Log into CartonFlow</a></li>
  <li><a href="https://app.cartonflow.io/signup">Start a free trial</a></li>
  <li><a href="/privacy-policy">Privacy Policy</a></li>
  <li><a href="/terms-of-service">Terms of Service</a></li>
  <li><a href="/cancellation">Cancellation &amp; Refund Policy</a></li>
</ul>

<h2>Pevara Systems</h2>
<p>CartonFlow is built and operated by Pevara Systems.<br/>
<a href="mailto:info@pevarasystems.com">info@pevarasystems.com</a></p>
